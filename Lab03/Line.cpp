...
// Класс "Линия" с реализацией методов
    ...
    void rotate(double angle, HDC hdc) override {
        ...
        if (start->getX() > end->getX()) {
            if (start->getY() > end->getY()) {
                ...
                //LineTo(hdc, start->getX() - length * cos(angle_rad + acos((start->getX() - end->getX()) / length)),
                ...
                //LineTo(hdc, start->getX() - length * cos(angle_rad), start->getY() - length * sin(angle_rad));
            }
            else if (start->getY() < end->getY()) {
                new_x = start->getX() - length * cos(angle_rad - acos((start->getX() - end->getX()) / length));
            ...
            if (start->getY() == end->getY()) {
                ...
                //LineTo(hdc, start->getX() - length * cos(angle_rad + M_PI), start->getY() - length * sin(angle_rad + M_PI));
            }
            else if (start->getY() > end->getY()) {
                ...
                //LineTo(hdc, start->getX() - length * cos(angle_rad - acos((end->getX() - start->getX()) / length) + M_PI),
            ...
            if (start->getY() < end->getY()) {
                ...
                //LineTo(hdc, start->getX() - length * cos(angle_rad - M_PI/2), start->getY() - length * sin(angle_rad - M_PI/2));
            }
            else if (start->getY() > end->getY()) {
                new_x = start->getX() - length * cos(angle_rad + M_PI/2);
                new_y = start->getY() - length * sin(angle_rad + M_PI/2);
