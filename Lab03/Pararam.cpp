...
// Класс "Параллелограмм" с реализацией методов
class ConcretePararam : public Pararam {
private:
    Point* p; // точка нижнего левого угла параллелограмма
    double side1; // 1-ая сторона параллелограмма (короткая)
    double side2; // 2-ая сторона параллелограмма (длинная)
    double angle; // меньший угол параллелограмма
...
public:
    ...
    //Жалкие попытки написать метод поворота по точке
